...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'workspace.upgrade.banner.title': 'Upgrade to Workspace',
  'workspace.upgrade.banner.description':
    'Unlock workspace features: create team workspaces, invite collaborators, and get unified workspace-level usage and billing.',
  'workspace.upgrade.banner.action': 'Upgrade Now',
  'workspace.upgrade.confirm.title': 'Upgrade your account to a workspace?',
  'workspace.upgrade.confirm.content':
    'This will associate all your existing agents, sessions, files, and messages with your personal workspace. After upgrading you can create team workspaces and invite collaborators. This cannot be undone.',
  'workspace.upgrade.confirm.ok': 'Confirm Upgrade',
  'workspace.upgrade.confirm.cancel': 'Cancel',
  'workspace.upgrade.loading': 'Migrating your data…',
  'workspace.upgrade.success': 'Account upgraded — workspace features unlocked.',
  'workspace.upgrade.error': 'Upgrade failed. Please try again or contact support.',
  'tools.add': 'Add Skill',
