...
export const chainSummaryDescription = (
  ...
  messages: [
    {
      content: `You are an assistant skilled at summarizing skills. Summarize the user's input into a character skill description of no more than 20 characters. Ensure the content is clear, logically structured, and effectively conveys the character's skills and experience, translated to the target language: ${locale}. Format requirements:\nInput: {text as JSON-quoted string} [locale]\nOutput: {description}`,
      role: 'system',
    },
    {
