...
description: >-
  ...
  Slack, Telegram, WhatsApp, LINE, QQ, WeChat, Feishu, and Lark, allowing users
  to interact with AI assistants directly in their favorite chat apps.
tags:
  - Channels
  - Message Channels
  - Integration
...
- **Multiple channels simultaneously** — A single agent can be connected to Discord, Slack, Telegram, WhatsApp, LINE, QQ, WeChat, Feishu, and Lark at the same time. LobeHub routes messages to the correct agent automatically.
...
| Feature                | Discord | Slack | Telegram | WhatsApp | LINE    | QQ  | WeChat | Feishu  | Lark    |
| ---------------------- | ------- | ----- | -------- | -------- | ------- | --- | ------ | ------- | ------- |
| Text messages          | Yes     | Yes   | Yes      | Yes      | Yes     | Yes | Yes    | Yes     | Yes     |
| Direct messages        | Yes     | Yes   | Yes      | Yes      | Yes     | Yes | Yes    | Yes     | Yes     |
| Group chats            | Yes     | Yes   | Yes      | No       | Yes     | Yes | Yes    | Yes     | Yes     |
| Reactions              | Yes     | Yes   | Yes      | No       | No      | No  | No     | Partial | Partial |
| Image/file attachments | Yes     | Yes   | Yes      | Inbound  | Inbound | Yes | No     | Yes     | Yes     |
