...
title: 渠道概览
description: >-
  将 LobeHub 代理连接到外部消息平台，如 Discord、Slack、Telegram、WhatsApp、LINE、QQ、微信、飞书和
...
- **同时支持多个渠道** — 单个代理可以同时连接到 Discord、Slack、Telegram、WhatsApp、LINE、QQ、微信、飞书和 Lark。LobeHub 会自动将消息路由到正确的代理。
...
| 功能        | Discord | Slack | Telegram | WhatsApp | LINE | QQ | 微信 | 飞书   | Lark |
| --------- | ------- | ----- | -------- | -------- | ---- | -- | -- | ---- | ---- |
| 文本消息      | 是       | 是     | 是        | 是        | 是    | 是  | 是  | 是    | 是    |
| 私人消息      | 是       | 是     | 是        | 是        | 是    | 是  | 是  | 是    | 是    |
| 群组聊天      | 是       | 是     | 是        | 否        | 是    | 是  | 是  | 是    | 是    |
| 表情反应      | 是       | 是     | 是        | 否        | 否    | 否  | 否  | 部分支持 | 部分支持 |
| 图片 / 文件附件 | 是       | 是     | 是        | 仅入站      | 仅入站  | 是  | 否  | 是    | 是    |
